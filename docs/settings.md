...
* [Settings](#settings)
    * [Allow `@private` to disable rules for that comment block (`ignorePrivate`)](#settings-allow-private-to-disable-rules-for-that-comment-block-ignoreprivate)
        * [Controlling spacing between code and comment blocks (`maxLines` and `minLines`)](#settings-allow-private-to-disable-rules-for-that-comment-block-ignoreprivate-controlling-spacing-between-code-and-comment-blocks-maxlines-and-minlines)
    * [Linting mode (`mode`)](#settings-linting-mode-mode)
    * [Alias Preference (`tagNamePreference`)](#settings-alias-preference-tagnamepreference)
        * [Default Preferred Aliases](#settings-alias-preference-tagnamepreference-default-preferred-aliases)
    * [`@override`/`@augments`/`@extends`/`@implements` Without Accompanying `@param`/`@description`/`@example`/`@returns` (`overrideReplacesDocs`, `augmentsExtendsReplacesDocs`, `implementsReplacesDocs`)](#settings-override-augments-extends-implements-without-accompanying-param-description-example-returns-overridereplacesdocs-augmentsextendsreplacesdocs-implementsreplacesdocs)
    * [Settings to Configure `check-types` and `no-undefined-types` (`preferredTypes`)](#settings-settings-to-configure-check-types-and-no-undefined-types-preferredtypes)


<a name="settings-allow-private-to-disable-rules-for-that-comment-block-ignoreprivate"></a>
## Allow <code>@private</code> to disable rules for that comment block (<code>ignorePrivate</code>)
...
<a name="settings-allow-private-to-disable-rules-for-that-comment-block-ignoreprivate-controlling-spacing-between-code-and-comment-blocks-maxlines-and-minlines"></a>
### Controlling spacing between code and comment blocks (<code>maxLines</code> and <code>minLines</code>)
...
<a name="settings-linting-mode-mode"></a>
## Linting mode (<code>mode</code>)
...
<a name="settings-alias-preference-tagnamepreference"></a>
## Alias Preference (<code>tagNamePreference</code>)
...
<a name="settings-alias-preference-tagnamepreference-default-preferred-aliases"></a>
...
<a name="settings-override-augments-extends-implements-without-accompanying-param-description-example-returns-overridereplacesdocs-augmentsextendsreplacesdocs-implementsreplacesdocs"></a>
## <code>@override</code>/<code>@augments</code>/<code>@extends</code>/<code>@implements</code> Without Accompanying <code>@param</code>/<code>@description</code>/<code>@example</code>/<code>@returns</code> (<code>overrideReplacesDocs</code>, <code>augmentsExtendsReplacesDocs</code>, <code>implementsReplacesDocs</code>)
...
<a name="settings-settings-to-configure-check-types-and-no-undefined-types-preferredtypes"></a>
## Settings to Configure <code>check-types</code> and <code>no-undefined-types</code> (<code>preferredTypes</code>)

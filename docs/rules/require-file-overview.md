...
* [`require-file-overview`](#require-file-overview)
    * [Options](#require-file-overview-options)
        * [`tags`](#require-file-overview-options-tags)
    * [Context and settings](#require-file-overview-context-and-settings)
    * [Failing examples](#require-file-overview-failing-examples)
    * [Passing examples](#require-file-overview-passing-examples)

...
* [`check-indentation`](#check-indentation)
    * [Options](#check-indentation-options)
        * [`excludeTags`](#check-indentation-options-excludetags)
    * [Context and settings](#check-indentation-context-and-settings)
    * [Failing examples](#check-indentation-failing-examples)
    * [Passing examples](#check-indentation-passing-examples)

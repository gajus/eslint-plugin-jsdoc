...
Adds a hyphen before the `@param` description if the string option is
"always" and is missing a hyphen.

Removes a hyphen if the string option is "never" and including a hyphen.
...
<Assertions rule="requireHyphenBeforeParamDescription" />

## Passing assertions

<Assertions rule="requireHyphenBeforeParamDescription" passing />

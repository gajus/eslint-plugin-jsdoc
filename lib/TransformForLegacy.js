...
function createLegacyUnionType(types, opt_attrMap) {
  ...
  if ('nullable' in attrMap) unionTypeNodeLegacy.setOptionalType(attrMap.nullable);
  if ('nonNullable' in attrMap) unionTypeNodeLegacy.setOptionalType(attrMap.nonNullable);
  if ('unknown' in attrMap) unionTypeNodeLegacy.setOptionalType(attrMap.unknown);
  if ('all' in attrMap) unionTypeNodeLegacy.setOptionalType(attrMap.all);
  if ('variable' in attrMap) unionTypeNodeLegacy.setOptionalType(attrMap.variable);
